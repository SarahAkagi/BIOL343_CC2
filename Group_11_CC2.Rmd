...
1. **Sarah Akagi** — 20393419
    + [BIOL343_CC2](https://github.com/SarahAkagi/BIOL343_CC2)
2. **Cheryl Cheng** - 
    + [BIOL343_CC2]()
3. **Eve Morrisson** - 
    + [BIOL343_CC2]()
...
cc1_data <- cc1_data[1:46, c(1, 5, 6, 8)]
...
```{r area-histogram, echo=F, message=F, warning=F}
library(ggplot2)
ggplot(aes(x = ovary_area), data = cc1_data) + geom_histogram(binwidth = 1) + facet_wrap(~population_type) + labs(x = "Ovary area (cm^2)", y = "Count", title = "Ovary area by population type") + theme_classic()
```
...
![Hydroponic_g13](./IMAGES/Hydroponic_g13.jpg)

Source: [BIOL 343 CC2](https://onq.queensu.ca/d2l/le/dropbox/1208667/492536/DownloadAttachment?fid=54136532)
